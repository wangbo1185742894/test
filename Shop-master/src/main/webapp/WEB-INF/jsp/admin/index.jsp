...
<head>
    ...
    <link href="${pageContext.request.contextPath}/src/main/webapp/css/slider.css"
          rel="stylesheet" type="text/css"/>
    <link href="${pageContext.request.contextPath}/src/main/webapp/css/common.css"
          rel="stylesheet" type="text/css"/>
    <link href="${pageContext.request.contextPath}/src/main/webapp/css/index.css"
          rel="stylesheet" type="text/css"/>
